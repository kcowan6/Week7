...
1. (Required) Unauthenticated Stored Cross-Site Scripting (XSS)
  ...
  - [X] GIF Walkthrough: <img src='# Project 7 - WordPress Pentesting
...
1. (Required) Unauthenticated Stored Cross-Site Scripting (XSS)
  - [X] Summary:  
    ...
    - Tested in version: 4.2
    - Fixed in version: 4.2
  - [X] GIF Walkthrough: <img src='https://imgur.com/a/VAPap.gif' title='GIF Walkthrough 1' width='' alt='GIF Walkthrough 1' />
